...
OhdsiRTools::checkUsagePackage("bipolarValidation")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/bipolarValidation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/bipolarValidation.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("bipolarValidation")
